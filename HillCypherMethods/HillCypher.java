...
public class HillCypher
{
    ...
    public String EncryptWord(String word)
    {
        ...
        if(arr.size() % 2 != 0)
        {
            ...
            arr.add(alphabet.charAt(randInt));
        }
    ...
    public static void main(String[] args)
    {
        try
        {
            ...
            System.out.println("The word to encrypt is: " + wordToEncrypt);
            String encryptedWord = hillCypher1.EncryptWord(wordToEncrypt);
            System.out.println("The encrypted word is: " + encryptedWord);

            String unencryptedWord = hillCypher1.DecryptWord(encryptedWord);
            System.out.println("The decrypted word is: " + unencryptedWord);
        }catch(IllegalArgumentException e)
        {
            System.out.println("Whoops, the key was not valid");
        }
